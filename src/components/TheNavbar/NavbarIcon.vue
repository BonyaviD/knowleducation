...
<template>
  <li class="flex items-center mr-8" ref="target">
    <div  class="bg-emerald-400 w-6 h-6 rounded-full flex items-center justify-center ml-2 mr-1.5">
      <div class="bg-slate-50 w-3 h-3 rounded-full flex items-center justify-center">
        <span class="bg-slate-700 rounded-full w-1.5 h-1.5 relative top-1 left-1" ref="eye"
