    ...
    <div class="flex  px-10">
      <div class="">
        <h2 class="text-5xl text-slate-700 mb-5">Learn
          <span class="relative">EDGE
            <span
              class="bg-gradient-to-r from-red-400 via-yellow-400 to-emerald-400 absolute top-12 mt-1 right-0 w-36 h-3 custom-border "></span>
          </span> Cases
        </h2>
        ...
        <div class="bg-slate-50 shadow-md px-4 py-2 mt-5 text-sm text-slate-400 font-sans w-80 flex items-center justify-between rounded-full">
